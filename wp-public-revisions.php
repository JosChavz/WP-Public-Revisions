<?php
	...
	if (!class_exists('\WpPublicRevisions\Core\Installer')) {
		require_once plugin_dir_path(__FILE__) . 'vendor/autoload.php';
	}
	
	define("WPPR_SLUG", "wp-public-revisions");
	define("WPPR_ROOT_PATH", plugin_dir_path(__FILE__));
	define("WPPR_FRONTEND_PATH", plugin_dir_url(__FILE__));
	define("WPPR_MAX_REVISIONS", 100);
