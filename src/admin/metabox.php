        ...
        public function wppr_meta_box_html($post)
        {
            ...
            <div id="wppr_metabox_container">
                ...
                <div id="wppr_metabox-buttons">
                    <button data-post-id="<?php echo esc_attr($post->ID) ?>" class="wppr_metabox-btn"
                            id="wppr_create-revision-btn">Create New Revision
                    </button>
                    ...
                    <button
                            ...
                            command="show-modal"
                            commandfor="wppr_history-revisions-dialog">View Past Revisions
                    </button>
                    ...
                    <dialog id="wppr_history-revisions-dialog">
                        <div id="wppr_history-revision-dialog-content">
                            <div class="wppr-dialog-header">
                                ...
                                <button
                                        class="wppr_metabox-btn"
                                        id="wppr_history-revision-close-btn" commandfor="wppr_history-revisions-dialog"
                                        command="close">Close
                                </button>
                            </div>
